package tensorflow.fatih.com.tensorflow.tracking;
...
import tensorflow.fatih.com.tensorflow.Classifier;
...
public class MultiBoxTracker {
  ...
  private final YaziSinir borderedText;
  ...
  public MultiBoxTracker(final Context context) {
    ...
    borderedText = new YaziSinir(textSizePx);
  }
  ...
  public synchronized void draw(final Canvas canvas) {
    ...
    for (final TrackedRecognition recognition : trackedObjects) {
      ...
      Log.d("Denemee",String.valueOf(cornerSize));
     // if (cornerSize<15) {
      ...
      borderedText.MetinYaz(canvas, trackedPos.left + cornerSize, trackedPos.bottom, labelString);//}
